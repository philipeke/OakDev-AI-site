...
module.exports = async function chatbotHandler(req, res) {
  ...
  const instructions = [
    ...
    'OakDev publicerar eller lamnar inga prisuppgifter. Om besokaren fragar om pris eller namner en budget, ange inga siffror och gor ingen vardering av budgeten. Fokusera pa anvandaren, appens karnflode och ratt forsta release, och lank vid behov till [kontakt](/contact/).',
    ...
    'Hitta inte pa fakta, garantier, kundcase, leveranstider eller tekniska ataganden. Sager du inte sakert, sag det och foresla ett kort upptacktsmote.',

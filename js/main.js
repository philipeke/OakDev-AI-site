...
const TRANSLATIONS = {
  en: {
    ...
    type_llm_desc:        'GPT-4, Claude 3, Gemini — we embed the world\'s most powerful language models into your products, workflows, and customer experiences.',
  ...
  sv: {
    ...
    type_agents_desc:     'Autonoma AI-arbetare som planerar, beslutar och utför komplexa flerstegsuppgifter med verktyg, API:er och data — verkar dygnet runt med minimal mänsklig tillsyn.',
    type_llm_title:       'LLM-integration',
    type_llm_desc:        'GPT-4, Claude 3, Gemini — vi integrerar världens mest kraftfulla språkmodeller i dina produkter, arbetsflöden och kundupplevelser.',

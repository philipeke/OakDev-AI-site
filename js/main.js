...
const TRANSLATIONS = {
  en: {
    ...
    nuria_tagline:         'Sunni Islamic Companion',
    nuria_name:            'Nuria',
    nuria_desc:            'A spiritually immersive Sunni Islamic app offering daily prayers, Quran readings, hadith, and guidance — beautifully designed for Muslims seeking a deeper connection to their faith.',
  ...
  sv: {
    ...
    nuria_tagline:         'Sunniislamisk följeslagare',
    nuria_name:            'Nuria',
    nuria_desc:            'En andligt fördjupande sunniislamisk app med dagliga böner, koranläsning, hadith och vägledning — vackert utformad för muslimer som söker en djupare kontakt med sin tro.',

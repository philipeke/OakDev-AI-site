...
const TRANSLATIONS = {
  en: {
    ...
    tp_name:              'TipsyPal',
    tp_desc:              'The smartest way to tip — TipsyPal calculates the perfect amount, splits bills instantly, and makes every dining experience completely seamless.',
    tp_cta:               'Visit TipsyPal',
    vespera_tagline:      'Evening Prayer App',
    vespera_name:         'Vespera',
    vespera_desc:         'A beautiful daily devotional app for evening prayers, scripture readings, and spiritual reflection. Elegantly designed for quiet, meaningful moments.',
  ...
  sv: {
    ...
    studio_hero_sub:      'Från idé till App Store designar och lanserar OakDev nativa, cross-platform och AI-drivna applikationer som användare älskar och företag bygger på.',
    ...
    tp_name:              'TipsyPal',
    tp_desc:              'Det smartaste sättet att ge dricks. TipsyPal beräknar perfekt belopp, delar notan direkt och gör varje matupplevelse helt smidig.',
    tp_cta:               'Besök TipsyPal',
    vespera_tagline:      'App för aftonbön',
    vespera_name:         'Vespera',
    vespera_desc:         'En vacker daglig andaktsapp för aftonbön, skriftläsning och andlig reflektion. Elegant designad för lugna, meningsfulla stunder.',
    vespera_cta:          'Besök Vespera',
    tech_tag:             'Teknikstack',
    tech_title:           'Byggt med modern teknologi',

...
const TRANSLATIONS = {
  ...
  sv: {
    ...
    about_story_title:      'Grundat i Uddevalla. Byggd för framtiden.',
    ...
    about_team_sub:         'Ett tight-knit team av IT-expertis och utvecklare, AI-byggare och kreativa tänkare, förenade av kärleken till den senaste tekniken.',
    about_philip_title:     'Lead Developer & AI-specialist',

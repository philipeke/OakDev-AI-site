...
const TRANSLATIONS = {
  en: {
    ...
    about_sub:              'From IT consultants on the west coast of Sweden to an AI-powered app studio — we have been at the frontier of tech for over two decades. Passionate, relentless, and always shipping.',
    ...
    about_stats_stacks:     'Tech Stacks Mastered',
    about_stats_uptime:     'Uptime Guarantee',
    about_team_tag:         'The People',
    about_team_title:       'Meet the Team',
    about_team_sub:         'A tight-knit crew of engineers, AI builders, and creative thinkers — united by a love for cutting-edge technology.',
    ...
    about_elin_bio:         'Elin bridges the gap between raw AI capabilities and real-world applications. She builds the pipelines, agents, and automation flows that make our AI products actually work — reliably and at scale.',
    about_jonna_title:      'Customer & Technical Support',
    about_jonna_bio:        'Jonna is the first face our clients meet and the last to let go. She ensures every project runs smoothly, every client feels heard, and every delivery lands exactly right.',
    about_jonathan_title:   'Marketing & Communication',
    about_jonathan_bio:     'Jonathan shapes how the world sees OakDev. From brand strategy to content and growth — he builds the signal that cuts through the noise.',
    ...
    about_v1_desc:          'Every solution we build is designed with AI in mind from day one — not bolted on as an afterthought.',
    ...
    about_v3_desc:          'No bloated processes. You talk directly to the engineers building your product. We ship fast, we communicate clearly.',
  ...
  sv: {
    ...
    about_sub:              'Från IT-konsulter på svenska västkusten till ett AI-drivet app-studio — vi har stått i teknikens framkant i över två decennier. Passionerade, envisa och alltid på gång.',
    about_story_tag:        'Resan',
    about_story_title:      'Grundat i Uddevalla. Kopplat till Framtiden.',
    about_story_p1:         'Det började med en kärlek till kod och en besatthet av att lösa problem. I över 20 år har vi befunnit oss djupt i programvaruutvecklingens skyttegravar — byggt databaser, webbsystem, e-handelsplattformar och företagssystem för kunder i hela Sverige och utomlands.',
    about_story_p2:         'När AI började omforma branschen stod vi inte och tittade — vi kastade oss in. Vi verktygsbytte, byggde om och uppfann oss själva på nytt som ett AI-nativt produktstudio. Idag designar och levererar vi AI-agenter, automatiseringspipelines, maskininlärningsintegrationer och skräddarsydda LLM-drivna applikationer.',
    ...
    about_team_sub:         'Ett tight-knit team av ingenjörer, AI-byggare och kreativa tänkare — förenade av kärleken till den senaste tekniken.',
    about_philip_title:     'Lead Developer & AI-specialist',
    ...
    about_elin_bio:         'Elin överbryggar klyftan mellan råa AI-förmågor och verkliga applikationer. Hon bygger de pipelines, agenter och automationsflöden som gör att våra AI-produkter faktiskt fungerar — pålitligt och i skala.',
    about_jonna_title:      'Kund- & Teknisk Support',
    about_jonna_bio:        'Jonna är det första ansikte våra kunder möter och den sista att släppa taget. Hon ser till att varje projekt flödar smidigt, varje kund känner sig hörd och varje leverans landar precis rätt.',
    about_jonathan_title:   'Marknadsföring & Kommunikation',
    about_jonathan_bio:     'Jonathan formar hur världen ser OakDev. Från varumärkesstrategi till innehåll och tillväxt — han bygger signalen som skär genom bruset.',
    ...
    about_v1_desc:          'Varje lösning vi bygger är designad med AI i åtanke från dag ett — inte påklistrat i efterhand.',
    ...
    about_v3_desc:          'Inga uppsvällda processer. Du pratar direkt med ingenjörerna som bygger din produkt. Vi levererar snabbt, vi kommunicerar tydligt.',
    about_v4_title:         'Alltid Lärande',
    about_v4_desc:          'Tekniklandskapet rör sig snabbt. Vi rör oss snabbare — utforskar ständigt nya modeller, verktyg och ramverk för att ligga steget före.',

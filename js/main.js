...
const TRANSLATIONS = {
  en: {
    ...
    cons_why_sub:          'We are hands-on engineers, not PowerPoint consultants. We write the code, run the infrastructure, and stay accountable for the result.',
    cons_why1_title:       'Senior-Only Engineers',
    cons_why1_desc:        'No juniors. Every engagement is handled by engineers with 8+ years of production experience.',
    ...
    cons_step3_desc:       'Senior engineers build, test, and iterate in rapid sprints with weekly demos and full transparency.',
    cons_step4_num:        '04',
    ...
    cons_pricing_sub:      'Flexible options — whether you need an hour of advice or a dedicated engineering team.',
    pkg_cons1_name:        'Hourly',
    pkg_cons1_price:       '800 SEK',
    pkg_cons1_period:      '/hr',
    pkg_cons1_desc:        'Perfect for targeted advice, code reviews, or quick fixes.',
    pkg_cons1_f1:          'Senior engineer on demand',
    ...
    pkg_cons2_period:      '/mo',
    pkg_cons2_desc:        'Ongoing engineering support and strategic advisory every month.',
    ...
    contact_hero_sub:       'We are a small team of tech enthusiasts with 20 years in the game — and we genuinely love talking about new technology. Reach out however feels right.',
    ...
    contact_about_text:     'OakDev & AI AB is a Swedish app studio and AI product company, stationiert in Uddevalla on the west coast of Sweden. We are a tight-knit team of passionate engineers with over 20 years of combined experience in software, web, and product development.',
  ...
  sv: {
    ...
    studio_types_title:   'Varje typ av app.',
    ...
    type_mvp_desc:        'Från idé till fungerande produkt på veckor. Validerade MVP:er byggda för snabbhet så du kan testa, lära och iterera.',
    ...
    studio_cta_desc:      'Berätta vad du bygger. Vi tar det från koncept till lansering.',
    ...
    /* AI & Automation page */
    ai_hero_badge:        'AI & Automation',
    ai_hero_title1:       'Företagets framtid',
    ...
    cons_hero_sub:         'Från en enkel webbplats till fullständig digital transformation — vi tar med oss senior ingenjörskompetens till företag av alla storlekar. Webbplatser, webbutiker, databaser, molnet och allt däremellan.',
    ...
    cons_why_sub:          'Vi är hands-on ingenjörer, inte PowerPoint-konsulter. Vi skriver koden, driver infrastrukturen och tar ansvar för resultatet.',
    cons_why1_title:       'Endast Seniora Ingenjörer',
    cons_why1_desc:        'Inga juniorer. Varje uppdrag hanteras av ingenjörer med 8+ års produktionserfarenhet.',
    ...
    cons_step3_desc:       'Seniora ingenjörer bygger, testar och itererar i snabba sprintar med veckovisa demos och full transparens.',
    cons_step4_num:        '04',
    ...
    cons_pricing_sub:      'Flexibla alternativ — oavsett om du behöver en timmes råd eller ett dedikerat ingenjörsteam.',
    pkg_cons1_name:        'Timvis',
    pkg_cons1_price:       '800 kr',
    pkg_cons1_period:      '/tim',
    pkg_cons1_desc:        'Perfekt för riktad rådgivning, kodgranskning eller snabba åtgärder.',
    pkg_cons1_f1:          'Senior ingenjör on demand',
    ...
    pkg_cons2_desc:        'Löpande ingenjörsstöd och strategisk rådgivning varje månad.',
    ...
    cons_cta_desc:         'Berätta vad du behöver. Vi skisserar det, sätter pris och börjar bygga — vanligtvis inom en vecka.',

    // Contact page (SV)
    contact_hero_badge:     'Kontakt',
    contact_hero_title:     'Låt Oss Bygga Något',
    contact_hero_title2:    'Tillsammans',
    contact_hero_sub:       'Vi är ett litet team av teknikentusiaster med 20 år i branschen — och vi älskar verkligen att prata om ny teknik. Hör av dig hur det passar dig bäst.',
    ...
    contact_about_text:     'OakDev & AI AB är ett svenskt app studio och AI-produktbolag, stationerat i Uddevalla på Sveriges västkust. Vi är ett tight-knit team av passionerade ingenjörer med över 20 års samlad erfarenhet inom mjukvara, webb och produktutveckling.',
